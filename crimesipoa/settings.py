"""
Django settings for crimesipoa project.
...
SECRET_KEY = 'yk8y3dpty&2a6zr&$&^*+1lz%1y4_=@@gl6_*%&4vmxub*eae='
...
ROOT_URLCONF = 'crimesipoa.urls'

TEMPLATE_DIRS = (
    os.path.join(os.path.realpath(os.path.dirname(__file__)), '../templates'),
)

WSGI_APPLICATION = 'crimesipoa.wsgi.application'
